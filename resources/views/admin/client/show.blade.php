...
<div class="flex justify-between items-start mb-6">
    ...
    <div class="flex space-x-2">
        <a href="{{ route('admin.clients.edit', $client) }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg">
            Izmeni
        </a>
        <a href="{{ route('admin.legal-cases.create', ['client_id' => $client->id]) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">
            + Novi predmet
        </a>
    </div>
</div>
