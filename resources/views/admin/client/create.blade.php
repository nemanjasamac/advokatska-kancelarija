...
@section('title', 'Novi klijent - Advokatska Kancelarija')

@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-800">Novi klijent</h1>
    <p class="text-gray-600">Unesite podatke o novom klijentu</p>
</div>
...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <form action="{{ route('admin.clients.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <div class="flex space-x-4">
                <label class="flex items-center">
                    <input type="radio" name="client_type" value="fizicko" {{ old('client_type', 'fizicko') === 'fizicko' ? 'checked' : '' }} class="mr-2">
                    Fizičko lice
                </label>
                <label class="flex items-center">
                    <input type="radio" name="client_type" value="pravno" {{ old('client_type') === 'pravno' ? 'checked' : '' }} class="mr-2">
                    Pravno lice
                </label>
            </div>
            @error('client_type')
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('admin.clients.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                Odustani
            </a>
