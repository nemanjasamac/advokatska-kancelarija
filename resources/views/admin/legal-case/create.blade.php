...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <form action="{{ route('admin.legal-cases.store') }}" method="POST">
        @csrf
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('admin.legal-cases.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                Odustani
            </a>
