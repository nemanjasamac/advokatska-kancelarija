...
<div class="flex justify-between items-start mb-6">
    ...
    <div class="flex space-x-2">
        <a href="{{ route('legal-cases.edit', $legalCase) }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg">
            Izmeni
        </a>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
    ...
    <div class="lg:col-span-2 bg-white rounded-lg shadow">
        <div class="p-6 border-b flex justify-between items-center">
            ...
            <a href="{{ route('documents.create', ['legal_case_id' => $legalCase->id]) }}" class="text-blue-600 hover:underline text-sm">
                + Dodaj dokument
            </a>
        </div>
        <div class="p-6">
...
<div class="bg-white rounded-lg shadow">
    <div class="p-6 border-b flex justify-between items-center">
        ...
        <a href="{{ route('appointments.create', ['legal_case_id' => $legalCase->id]) }}" class="text-blue-600 hover:underline text-sm">
            + Zakaži termin
        </a>
    </div>
    <div class="p-6">
